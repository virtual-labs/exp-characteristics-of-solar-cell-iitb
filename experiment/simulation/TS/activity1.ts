...
function activity1() {
	...
	pp.showtitle(
		`<p id="exp-title">To Study The Characteristics Of Solar Cell</p>`,
		3
	);
	pp.showscore(0, 3);
	canvas = pp.canvas;
...
function a1_load_questions() {}
{
	...
	question.push({
		srno: 5,
		question:
			"Select <span style='color: #018fc3'>Anti Reflection Coating</span>",
	...
	question.push({
		srno: 8,
		question:
			"Select <span style='color: #018fc3'> Depletion Layer </span>",
		ans: 'Depletion Layer',
		hint: ['Rectnagular box with sensor', 'Horizontal', ''],
	});
}
