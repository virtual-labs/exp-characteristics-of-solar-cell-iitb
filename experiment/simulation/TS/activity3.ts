...
let img1: Chemistry.Custome_image;
...
function load_values() {
    let slider: HTMLInputElement = <HTMLInputElement> document.getElementById('inp1');

    let show_range: HTMLInputElement = <HTMLInputElement> document.getElementById('show-range-inp');

    let val1: HTMLInputElement = <HTMLInputElement> document.getElementById('inp2');

    let val2: HTMLInputElement = <HTMLInputElement> document.getElementById('inp3');

    let val3: HTMLInputElement = <HTMLInputElement> document.getElementById('inp4');
