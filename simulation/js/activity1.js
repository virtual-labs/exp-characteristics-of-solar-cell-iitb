...
function activity1() {
    ...
    pp.showtitle(`<p id="exp-title">To Study The Characteristics Of Solar Cell</p>`, 3);
    pp.showscore(0, 3);
    canvas = pp.canvas;
...
{
    question = [];
    question.push({ srno: 1, question: "Select <span style='color: #018fc3'> Load ( light bulb) </span>", ans: "load", hint: ["Has Suction and Discharge", "Has valve attached", "Triangular Base"] });
    question.push({ srno: 2, question: "Select <span style='color: #018fc3'> Cover Glass </span>", ans: "cover_glass", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
    question.push({ srno: 3, question: "Select <span style='color: #018fc3'> Photon Source </span>", ans: "photon_source", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
    ...
    question.push({ srno: 5, question: "Select <span style='color: #018fc3'>Anti Reflection Coating</span>", ans: "anti_reflection_coating", hint: ["U-Shape", "Mounted horizontally", "Has two pins"] });
    question.push({ srno: 6, question: "Select <span style='color: #018fc3'> N-Type Layer </span>", ans: "n_type_layer", hint: ["Rectangular box with sensor", "Display SET T", "Has two wires protruding down"] });
    question.push({ srno: 7, question: "Select <span style='color: #018fc3'> P-Type Layer </span>", ans: "p_type_layer", hint: ["Rectnagular box with sensor", "Horizontal", ""] });
    question.push({ srno: 8, question: "Select <span style='color: #018fc3'> Depletion Layer </span>", ans: "depletion_layer", hint: ["Rectnagular box with sensor", "Horizontal", ""] });
}
...
function load_higlighted_images() {
    ...
    a1_labels = [
        new Chemistry.Text("load", new Chemistry.Point(400, 500), canvas),
        new Chemistry.Text("condenser", new Chemistry.Point(1100, 600), canvas),
        new Chemistry.Text("photon_source", new Chemistry.Point(1450, 800), canvas),
        new Chemistry.Text("electrode", new Chemistry.Point(1100, 680), canvas),
        new Chemistry.Text("anti_reflection_coating", new Chemistry.Point(1100, 550), canvas),
        new Chemistry.Text("n_type_layer", new Chemistry.Point(1100, 483), canvas),
        new Chemistry.Text("p_type_layer", new Chemistry.Point(1100, 350), canvas),
        new Chemistry.Text("depletion_layer", new Chemistry.Point(1100, 414), canvas)
    ];
}
